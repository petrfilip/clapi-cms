      ...
      onDropEvent={(componentKey) => {
        setActionSidebar(
          <TypeDefinitionInputSettings
            ...
            onConfirm={(obj) => onNewDefinition(typeDefinitionConfig, obj, onUpdateConfig)}
...
const TypeDefinitionGroupBuilder = ({ typeDefinitionConfig, onUpdateDefinition }) => {
  ...
  return (
    <TypeDefinitionGroupBuilderContainer>
      {getTypeDefinitionBuilderContainer(typeDefinitionConfig, setActionSidebar, onUpdateDefinition)}
    </TypeDefinitionGroupBuilderContainer>
  )
}
